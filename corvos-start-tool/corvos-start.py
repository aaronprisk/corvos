...
LARGE_FONT = ("Verdana", 14) # font's family is Verdana, font's size is 14 
MED_FONT = ("Verdana", 12) # font's family is Verdana, font's size is 12 
SMALL_FONT = ("Verdana", 6) # font's family is Verdana, font's size is 10 
...
class MainWindow(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for F in (StartPage, PageOne, PageTwo, PageThree, PageFour, PageFive, PageSix, PageSeven): # for each page
...
def browsefunc(self):
        ...
        os.system("cp " + str(filename) + " /home/aaron/wall.jpg")
        self.controller.show_frame(PageTwo)

def softwarescript(self):
        os.system('~/corvos-start-tool/softwaresetup.sh')
...
class PageThree(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, bg="#442178", fg="white", activebackground="#5b4878", activeforeground="white", font=MED_FONT, text='Yes', command=lambda : cleanscript(self))
...
class PageFour(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label.pack()
        sub_label = tk.Label(self, text='Enables the kiosk mode setting on the student desktop.')
        sub_label.pack(pady=10, padx=10)
 
        button1 = tk.Button(self, bg="#442178", fg="white", activebackground="#5b4878", activeforeground="white", font=MED_FONT, text='Yes', command=lambda : lockscript(self))
...
class PageFive(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label.pack()
        sub_label = tk.Label(self, text='EX: https://www.corvoslinux.org')
        sub_label.pack(pady=5, padx=10)
        linkurl = tk.Entry(self, width=40)
        linkurl.pack(pady=10, padx=10)
...
class PageSix(tk.Frame):
    def __init__(self, parent, controller):
        ...
        photo_label.pack(pady=50, padx=10)
        photo_label.image = photo
        label = tk.Label(self, text="Install some popular third party software?", font=LARGE_FONT)
        label.pack(pady=5, padx=10)
        sublabel = tk.Label(self, text="Google Chrome and Adobe Flash", font=MED_FONT)
        sublabel.pack(pady=5, padx=10)
        sublabel = tk.Label(self, text="Please note that Google Chrome and Adobe Flash are not open source and are subject to a license agreement.", font=SMALL_FONT)
        sublabel.pack(pady=5, padx=10)
        button1 = tk.Button(self, bg="#442178", fg="white", activebackground="#5b4878", activeforeground="white", font=MED_FONT, text='Yes', command=lambda : softwarescript(self))
        button2 = tk.Button(self, bg="#f0413c", fg="white", activebackground="#f09390", activeforeground="white", font=MED_FONT, text='No, thanks', command=lambda : controller.show_frame(PageSeven))
        button1.pack()
        button2.pack()
